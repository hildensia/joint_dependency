...
if [ ${FIVE} -eq 1 ]
then
python ${JOINT_DEP_EXP_PY_FOLDER}joint_dep_exp.py -o random --use_simple_locking_state --use_joint_positions --joint_state "small" -r 30 -q 30 --lockboxfile ${LOCKBOXES_YAML_FOLDER}lockbox_serial_5_with_branch.yaml
python ${JOINT_DEP_EXP_PY_FOLDER}joint_dep_exp.py -o random --use_simple_locking_state --use_joint_positions --joint_state "small" -r 30 -q 30 --lockboxfile ${LOCKBOXES_YAML_FOLDER}lockbox_serial_5_with_branch.yaml
python ${JOINT_DEP_EXP_PY_FOLDER}joint_dep_exp.py -o random --use_simple_locking_state --use_joint_positions --joint_state "small" -r 30 -q 30 --lockboxfile ${LOCKBOXES_YAML_FOLDER}lockbox_serial_5_with_branch.yaml
fi
if [ ${SIX} -eq 1 ]
...
if [ ${FIVE} -eq 1 ]
then
python ${JOINT_DEP_EXP_PY_FOLDER}joint_dep_exp.py -o entropy --use_simple_locking_state --use_joint_positions --joint_state "small" -r 30 -q 30 --lockboxfile ${LOCKBOXES_YAML_FOLDER}lockbox_serial_5_with_branch.yaml
python ${JOINT_DEP_EXP_PY_FOLDER}joint_dep_exp.py -o entropy --use_simple_locking_state --use_joint_positions --joint_state "small" -r 30 -q 30 --lockboxfile ${LOCKBOXES_YAML_FOLDER}lockbox_serial_5_with_branch.yaml
python ${JOINT_DEP_EXP_PY_FOLDER}joint_dep_exp.py -o entropy --use_simple_locking_state --use_joint_positions --joint_state "small" -r 30 -q 30 --lockboxfile ${LOCKBOXES_YAML_FOLDER}lockbox_serial_5_with_branch.yaml
fi
if [ ${SIX} -eq 1 ]
...
if [ ${FIVE} -eq 1 ]
then
python ${JOINT_DEP_EXP_PY_FOLDER}joint_dep_exp.py -o cross_entropy --use_simple_locking_state --use_joint_positions --joint_state "small" -r 30 -q 30 --lockboxfile ${LOCKBOXES_YAML_FOLDER}lockbox_serial_5_with_branch.yaml
python ${JOINT_DEP_EXP_PY_FOLDER}joint_dep_exp.py -o cross_entropy --use_simple_locking_state --use_joint_positions --joint_state "small" -r 30 -q 30 --lockboxfile ${LOCKBOXES_YAML_FOLDER}lockbox_serial_5_with_branch.yaml
python ${JOINT_DEP_EXP_PY_FOLDER}joint_dep_exp.py -o cross_entropy --use_simple_locking_state --use_joint_positions --joint_state "small" -r 30 -q 30 --lockboxfile ${LOCKBOXES_YAML_FOLDER}lockbox_serial_5_with_branch.yaml
fi
if [ ${SIX} -eq 1 ]
...
if [ ${FIVE} -eq 1 ]
then
python ${JOINT_DEP_EXP_PY_FOLDER}joint_dep_exp.py -o heuristic_proximity --use_simple_locking_state --use_joint_positions --joint_state "small" -r 30 -q 30 --lockboxfile ${LOCKBOXES_YAML_FOLDER}lockbox_serial_5_with_branch.yaml
python ${JOINT_DEP_EXP_PY_FOLDER}joint_dep_exp.py -o heuristic_proximity --use_simple_locking_state --use_joint_positions --joint_state "small" -r 30 -q 30 --lockboxfile ${LOCKBOXES_YAML_FOLDER}lockbox_serial_5_with_branch.yaml
python ${JOINT_DEP_EXP_PY_FOLDER}joint_dep_exp.py -o heuristic_proximity --use_simple_locking_state --use_joint_positions --joint_state "small" -r 30 -q 30 --lockboxfile ${LOCKBOXES_YAML_FOLDER}lockbox_serial_5_with_branch.yaml
fi
if [ ${SIX} -eq 1 ]
